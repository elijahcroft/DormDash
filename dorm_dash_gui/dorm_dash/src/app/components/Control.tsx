    ...
    return (
        <div className="flex flex-col rounded-4xl bg-[#F1F0E4]  min-w-140 min-h-120 outline">
            ...
            <div className="flex flex-row items-stretch bg-[#DDDAD0] min-h-10 text-[#44444E] ">
                <div className="flex min-w-1/3 justify-center">Navigating</div>
                <div className="flex min-w-1/3b  justify-center">Add item</div>
                <div className="flex min-w-1/3 justify-center   ">Delivering</div>
            </div>
        </div>
    )
}